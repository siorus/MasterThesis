...
NTP Amplification DDoS Attack. In: \textit{Cloudflare} [online]. [cit. 2019-12-\
01]. Dostupné z: https://www.cloudflare.com/learning/ddos/ntp-amplification-ddo\
s-attack/

\bibitem{s0goWNnWp5OjqREE}
Encryption. In: \textit{Network Time Protocol} [online]. [cit. 2019-12-01]. Dos\
tupné z: http://www.ntp.org/ntpfaq/NTP-s-algo-crypt.htm
...
VLAN Hopping: How to Prevent an Attack. In: \textit{AT\&T Cybersecurity} [online\
]. 2018 [cit. 2019-12-03]. Dostupné z: https://www.alienvault.com/blogs/securit\
y-essentials/vlan-hopping-and-mitigation
