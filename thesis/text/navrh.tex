...
\begin{longtable}[htbp]{|C{2em}L{5.43em}L{5.43em}C{6em}C{5.43em}C{5.43em}C{5.43em}|}
	...
	\centering
		...
		\rowcolor[rgb]{ .933,  .933,  .933} 2 & Modifikovanie konfigurácie pomocou SNMP & Obmedzenie SNMP iba na èítanie & Management & CRITICAL & VŠETKY & VŠETKY \\
		...
		\rowcolor[rgb]{ .933,  .933,  .933} 6     & Sťažená identifikácia SNMP správ z rôznych IP & Definovanie lokácie SNMP serveru & Management & LOW   & VŠETKY & VŠETKY \\
		...
		\rowcolor[rgb]{ .933,  .933,  .933} 8     & Zmeny názvov rozhraní medzi reštartami a nemožnosť monitorovanie pomocou SNMP & SNMP statické nemenné meno rozhrania aj po reštarte zariadenia & Management & HIGH  & VŠETKY & VŠETKY \\
%	\caption{Add caption}
	\label{tab:addlabel1}%
\end{longtable}%
...
\begin{longtable}[htbp]{|C{2.5em}L{8em}L{8em}p{5.6em}p{4.7em}p{6.57em}|}
	...
	\hline
	1 & Odpočúvanie SNMP verzie 1 a 2c & Použitie SNMP verie 3 pokiaľ je SNMP používané & Management & CRITICAL & VŠETKY \\
	...
	\rowcolor[rgb]{ .933,  .933,  .933} 8 & Zmeny názvov rozhraní medzi reštartami a nemožnosť monitorovanie pomocou SNMP & SNMP statické nemenné meno rozhrania aj po reštarte zariadenia & Management & HIGH & VŠETKY \\ \hline
	\caption{Add caption}
	\label{tab:addlabel}%
\end{longtable}%
...
\newpage
% Table generated by Excel2LaTeX from sheet 'Hárok1'
\begin{longtable}[htbp]{|C{2.5em}>{\columncolor[rgb]{ .933,  .933,  .933}}L{8em}L{8em}>{\columncolor[rgb]{ .933,  .933,  .933}}p{5.6em}p{4.7em}>{\columncolor[rgb]{ .933,  .933,  .933}}p{6.57em}|}
	\hline
	\centering
