...
%Takáto funkcia je nutná keďže mohé nastavenia idú aplikovať v rôznych kontextoch, prípadne rôzne verzie operačných systémov bežiacich na zariadení majú rozdielny spôsob konfigurácie.
