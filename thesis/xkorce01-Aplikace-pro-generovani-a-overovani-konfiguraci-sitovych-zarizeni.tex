...
\includepdf[pages=1]%
  {pdf/diplomka-dosky}% název souboru nesmí obsahovat mezery!
...
\includepdf[pages=1]%
  {pdf/diplomka-titulka}% název souboru nesmí obsahovat mezery!
\vlozprazdnoustranku  %pri dvojstrannem tisku se prida prazdna stranka
...
\includepdf[pages=1]%
  {pdf/diplomka-zadanie}% název souboru nesmí obsahovat mezery!
\vlozprazdnoustranku   %pri dvojstrannem tisku se prida prazdna stranka
